...
## MobulaRayss (GLMM with negative binomial error function)
MobulaRays_ZINB_GLMM_full_model <- glmmadmb(formula=MobulaRays~StudyYear+CurrentCode+SeaTempCelsius+VisibilityMeters+ElNinoIndex+SIN_TIME+COS_TIME+(1|DiverCode)+(1|SiteCode),data=CocosData,family="nbinom",extra.args="-ndi 30000",zeroInflation=TRUE)
